...
class DataClassMeta(type):
    ...
    def __new__(mcs, name, bases, dict_, **kwargs):
        ...
        # TODO: gross due to PyPy being bugged (see is_user_func) - find better workaround
        all_attrs = {a for b in bases for a in dir(b) if getattr(b, a) is not getattr(object, a, ...) and
                     is_user_func(getattr(b, a))} | dict_.keys()
...
def is_user_func(obj: Any) -> bool:
    ...
    TODO not accurate on Pypy, see <https://foss.heptapod.net/pypy/pypy/-/issues/3367>"""
